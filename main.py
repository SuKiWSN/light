...
def calculate_background_brightness(image_path, segLightDir, segBgDir):
    # 读取彩色图像
    ...
    return 8 * np.log10(0.25/bg_mean_luminance * light_proportion*1000 * light_mean_luminance**2)
...
if __name__ == '__main__':
    ...
    for imageName in imgList:
        if imageName.split('.')[-1] in ['png', 'jpg']:
            ...
            background_brightness = calculate_background_brightness(image_path, saveLightDir, saveBgDir)
